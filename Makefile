...
SRCS =  Pattern.cpp Matcher.cpp BetterScrollView.cpp CLVColumn.cpp CLVColumnLabelView.cpp CLVEasyItem.cpp CLVListItem.cpp ColumnListView.cpp Cursors.cpp NewStrings.cpp PrefilledBitmap.cpp ScrollViewCorner.cpp phonelist.cpp callregslotview.cpp phonelistslotview.cpp bemobile.cpp dialabout.cpp dialeditpbook.cpp dialnewsms.cpp dialcalevent.cpp dialcalendar.cpp gsm.cpp main.cpp mainwindow.cpp workview.cpp calview.cpp pbbynameview.cpp pbview.cpp smsview.cpp smsboxview.cpp smsinboxview.cpp statusview.cpp mobileview.cpp initwindow.cpp
